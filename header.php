			...
			<div class="header-popup header-phone-popup" data-header-popup="phone">
				...
				<div class="header-popover header-phone-panel" id="header-phone-panel" hidden data-header-popup-panel>
					<div class="header-popover__heading">
						...
						<button type="button" aria-label="<?php esc_attr_e( 'Close phone numbers', 'kanapka-theme' ); ?>" data-header-popup-close><?php echo kanapka_theme_ui_icon( 'x', 18 ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></button>
					</div>
