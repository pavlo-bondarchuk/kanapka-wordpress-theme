	...
	<div class="product-card__body">
		...
		<div class="product-card__meta">
			...
			<?php if ( $product->is_purchasable() && $product->is_in_stock() ) : ?>
				<a class="button product-card__button" href="<?php echo esc_url( $product->add_to_cart_url() ); ?>" data-quantity="1" data-product_id="<?php echo esc_attr( $product->get_id() ); ?>" rel="nofollow"><?php echo esc_html( $product->add_to_cart_text() ); ?></a>
			<?php endif; ?>
		</div>
	</div>
</article>
