...
<section class="home-section section" aria-labelledby="category-catalogue-title">
	<div class="container">
		<div class="section-heading">
			<h2 id="category-catalogue-title"><?php esc_html_e( 'Каталог продукції', 'kanapka-theme' ); ?></h2>
			<a href="<?php echo esc_url( function_exists( 'wc_get_page_permalink' ) ? wc_get_page_permalink( 'shop' ) : home_url( '/shop/' ) ); ?>"><?php esc_html_e( 'Усі категорії', 'kanapka-theme' ); ?> →</a>
		</div>
