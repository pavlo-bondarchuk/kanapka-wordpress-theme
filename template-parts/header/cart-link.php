...
<div class="header-popup header-cart kanapka-mini-cart-fragment" data-header-popup="cart">
	<button class="icon-button" type="button" aria-expanded="false" aria-controls="header-mini-cart" aria-label="<?php echo esc_attr( sprintf( __( 'Cart, %d products', 'kanapka-theme' ), $cart_count ) ); ?>" data-header-popup-button>
