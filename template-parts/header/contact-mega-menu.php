...
$address_one = kanapka_theme_get_option( 'kanapka_contact_address_one', __( 'Київ', 'kanapka-theme' ) );
...
?>
<div class="contact-mega-menu" aria-label="<?php esc_attr_e( 'Контактна інформація', 'kanapka-theme' ); ?>">
	<div class="contact-mega-menu__column">
		<div class="contact-mega-menu__label"><?php echo esc_html( kanapka_theme_get_option( 'kanapka_contact_column_title', __( 'Контакти', 'kanapka-theme' ) ) ); ?></div>
	...
	<div class="contact-mega-menu__column">
		<div class="contact-mega-menu__label"><?php esc_html_e( 'Адреса', 'kanapka-theme' ); ?></div>
		<address><?php echo esc_html( $address_one ); ?><br><?php echo esc_html( $address_two ); ?></address>
		<?php if ( $hours ) : ?>
			<div class="contact-mega-menu__label"><?php echo esc_html( kanapka_theme_get_option( 'kanapka_contact_hours_title', __( 'Замовлення приймаються', 'kanapka-theme' ) ) ); ?></div>
			<p><?php echo nl2br( esc_html( $hours ) ); ?></p>
		<?php endif; ?>
		<?php if ( $button_url ) : ?>
			<a class="button" href="<?php echo esc_url( $button_url ); ?>"><?php echo esc_html( kanapka_theme_get_option( 'kanapka_contact_button_label', __( 'Контактна форма', 'kanapka-theme' ) ) ); ?></a>
		<?php endif; ?>
	</div>
</div>
